...
def say_greetings_text(tts: TTSModel, overlay: ImageOverlay, player: AudioPlayer) -> None:
...
def say_goodbye_text(tts: TTSModel, overlay: ImageOverlay, player: AudioPlayer) -> None:
...
def say_comment_text(tts: TTSModel, overlay: ImageOverlay, player: AudioPlayer, screen_base64: str) -> None:
